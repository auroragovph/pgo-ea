...
if(isset($_POST['submit'])){
  ...
  $income=$_POST['income'];
   ...
   $PhoneNumber=$_POST['PhoneNumber'];
    ...
    $sql = "INSERT INTO `tblappointment` (`ID`, `AptNumber`, `fname`, `lname`, `mname`, `age`, `civil`, `sex`, `purok`, `muni`, `brgy`, `prov`, `purok1`, `muni1`, `brgy1`, `prov1`, `birthdate`, `birthplace`, `school_name`, `School_address`, `current_y_level`, `gwa`, `question`, `question2`, `question3`, `father_name`, `address1`, `contact_no1`, `employer`, `occupation`, `mother_name`, `address2`, `contact_no2`, `employer2`, `occupation1`, `number_f_mem`, `income`, `Email`, `PhoneNumber` )
            VALUES ('', '{$AptNumber}', '{$fname}', '{$lname}', '{$mname}', '{$age}', '{$civil}', '{$sex}', '{$purok}', '{$muni}', '{$brgy}', '{$prov}', '{$purok1}', '{$muni1}', '{$brgy1}', '{$prov1}', '{$birthdate}', '{$birthplace}', '{$school_name}', '{$School_address}', '{$current_y_level}', '{$gwa}', '{$question}', '{$question2}', '{$question3}', '{$father_name}', '{$address1}', '{$contact_no1}', '{$employer}', '{$occupation}', '{$mother_name}', '{$address2}', '{$contact_no2}', '{$employer2}', '{$occupation1}', '{$number_f_mem}', '{$income}', '{$Email}', '{$PhoneNumber}') ";
    ...
    $msg='<div class="alert alert-success alert-dismissible">
                  ...
                  SCHOLAR HAS BEEN REVIEWED! Tracking Number is ' . $AptNumber[0] . '</h1>
                </div>';
  }
  else
    {
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">REVIEW PERSONAL INFORMATION</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <form action="verify.php" method="post" class="appointment-form" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                  	  <div class="row">
                  <div class="col-12">
                    <input type="text" class="form-control" name="AptNumber" value="<?php  echo $row['ID'];?>" hidden="">
                  </div>
                ...
                <br>
                 <div class="row">
                  ...
                  <div class="col-2">
                    <input type="text" class="form-control" name="mname" value="<?php  echo $row['mname'];?>" placeholder="Middle initial" required="">
                  </div>
                  <br>
                  <br>
                    <div class="col-12">
                    <input type="text" class="form-control" name="civil" value="<?php  echo $row['civil'];?>" placeholder="Civil Status" required="">
                  </div>
                </div>
                <BR>
                 <div class="row">
                  ...
                  <div class="col-6">
                   ...
                   <div class="col-sm-2">
                      ...
                      <input type="text" class="form-control" name="purok1" value="<?php  echo $row['present_ad'];?>" placeholder="Complete Present Address(ex. Brgy.2 Purok1, Baler Aurora, Aurora" required="">
                   ...
                   <div class="col-sm-2">
                      ...
                      <!-- select -->
                      <div class="form-group">
                      <input type="text" class="form-control" name="purok" value="<?php  echo $row['paddress'];?>" placeholder="Complete Permanent Address(ex. Brgy.2 Purok1, Baler Aurora, Aurora" required="">
                      </div>
                    </div>
              ...
              <div class="row">
                  ...
                  <div class="col-8">
                   ...
                   <!--   <div class="row">
                    ...
                    <input type="text" class="form-control"name="question2" value="<?php  echo $row['q3'];?>" placeholder="GWA from Last SEM/S.Y" required="">
                  ...
                  <div class="col-6">
                    <input type="text" class="form-control" name="occupation1" value="<?php  echo $row['occupation2'];?>" required="">
                  </div>
                  ...
                  <div class="col-6">
                    <input type="text" class="form-control" name="contact_no2" value="<?php  echo $row['contact1'];?>" required="">
                  </div>
                  ...
                  <div class="col-2">
                   ...
                   <div class="custom-file">
                    ...
                    <br>
                     <div class="col-4">
                    <button type="submit"  name="submit" value="Make an Appointment" class="btn btn-warning btn-block btn-flat float-right "><i class="fa fa-arrow-down"></i> ACCEPT SCHOLAR</button>
