        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <a href="add_office.php"><button type="submit" class="btn btn-warning"><i class="fa fa-plus"></i> Add</button></a>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              ...
              <tbody>
                ...
                ")or die(mysqli_error($con));
                  ...
                  ?>
                 <tr>
                  <td> <?php  echo $office_name=$row['office_name'];?></td>
                    <td><?php  echo $office_des=$row['office_des'];?> </td>
