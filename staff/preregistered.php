        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">     <a href="scholar.php"><button type="submit" class="btn btn-sm btn-warning mt-1"><i class="fa fa-question"></i> VERIFY</button></a> </li>
              <li class="breadcrumb-item active">     <a href="add_scholar.php"><button type="submit" class="btn btn-sm btn-success mt-1"><i class="fa fa-plus"></i> ADD</button></a> </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
         <div class="card">
            <div class="card-header bg-success">
              <h3 class="card-title">SCHOLAR</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
             ...
             <tbody>
               ...
               <?php } else { ?>
                               ...
                               <td>  <a href="view-appointment.php?view=<?php echo $row['AptNumber'];?>"><button type="submit" class="btn btn-sm btn-success mt-1"><i class="fa fa-search"></i> View</button></a>  
