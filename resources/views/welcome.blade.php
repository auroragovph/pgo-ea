...
<head>
	...
	<link rel="preload" href="{{ asset('tabler/css/landing.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
	...
	<header class="header js-header">
        <div class="container">
            <div class="d-flex align-items-center position-relative">
                <a href="/" class="logo">
                    <img src="{{ asset('logo/md.png') }}" alt="PGA Logo" title="">
                    <div>
	...
	<footer class="footer">
		<div class="container">
			<div class="row text-center text-lg-left">
				<div class="col-lg-6">
					<a href="https://aurora.gov.ph">Provincial Government of Aurora</a>
				</div>
				<div class="col-lg-6 text-lg-right">
					<a href="{{ route('pripol') }}">Privacy Policy</a>
				</div>
			</div>
		</div>
	</footer>
...
<script src="{{ asset('tabler/js/landing.js') }}" async></script>
