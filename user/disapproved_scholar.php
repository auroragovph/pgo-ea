  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">DisApproved Scholars</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card-body">
              ...
              <tbody>
                ...
                $query1=mysqli_query($con,"
                  select * from tblappointment where status = '2' ;                 ;
                ")or die(mysqli_error($con));
                 ...
                 <!--     <td><a href="print.php?editid=<?php echo $row['id'];?>"><input type="checkbox" name="names[]" value="<?php echo $row['id'];?>" class="success"></a> </td> -->
                     ...
                     <td><a href="view_approved.php?view=<?php echo $row['ID'];?>"><button type="submit" class="btn btn-success">View</button></a>
