...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblappointment set Remark='$remark',Remark_by='$remark_by',Status='$status',particular='$particular',amount='$amount',period_covered='$period_covered' where ID='$cid'");
    if ($query) {
            ...
            <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
              <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <button type="button" class="info-box bg-light btn btn-sm btn-success " value="<?php echo $row['ID']; ?>">
                 <div class="info-box-content">
