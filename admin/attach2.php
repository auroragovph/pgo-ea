        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <a href="approved_scholar.php"><button type="submit" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back</button></a>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <form role="form" method="POST" action="attach.php"  enctype="multipart/form-data">
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="tracking_no" class="form-control" value="<?php  echo $row['AptNumber'];?>" placeholder="Enter ..." readonly>
                      </div>
