...
$query=mysqli_query($con, "insert into  barangay(brgy) value('$brgy')");
    if ($query) {
echo "<script>alert('New System barangay has been added.');</script>"; 
  ...
  ?>
    ...
    <!-- Main content -->
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" method="POST" action="add_barangay.php">
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="brgy" class="form-control" placeholder="Enter ...">
                      </div>
                    </div>
                  </div>
